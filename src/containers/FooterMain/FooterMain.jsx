...
const FooterMain = () => {
  return (
    ...
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Reactor Blog</a>.   All Rights Reserved.
    </span>
